    ...
    class Program
    {
        ...
        //Phase 7 & 8:
            ...
            // Hard - this gives the user four guesses.
                ...
                if (Difficulty == "easy")
                {
                    TotalGuessesAllowed = 8;
                    Console.WriteLine("-->You chose easy, now enter a number between 1 and 100.<--");
                }
                else if (Difficulty == "medium")
                {
                    TotalGuessesAllowed = 6;
                    Console.WriteLine("-->You chose medium, now enter a number between 1 and 100.<--");
                }
                ...
                while (NumberOfTries.Count < TotalGuessesAllowed)
                {
                    ...
                    if (NumberGuessed != RandomNumber && NumberOfTries.Count == TotalGuessesAllowed) {
